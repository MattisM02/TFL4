...
Containeranwendungen im Cloudbetrieb". Es vergleicht \textbf{34
	Konfigurationen} (21 Flag-Varianten + 13 Laufzeitprofile) automatisiert
und reproduzierbar.
...
\begin{longtable}[]{@{}
	...
	\endhead
	\rowcolor{rowalt}
	Garbage Collectors & G1GC (Default), ZGC, Shenandoah, Parallel GC, Serial GC (5) \\
	G1-Tuning          & MaxGCPauseMillis=50, Heap 256m, Heap 512m (3)               \\
	\rowcolor{rowalt}
	JVM-Interna        & Compressed OOPs aus, Compact Object Headers (JEP 450) (2)   \\
	Cloud-Relevanz     & MaxRAMPercentage=75, TieredStopAtLevel=1 (kein C2) (2)      \\
	\rowcolor{rowalt}
	Kombinationen      & +9 Konfigurationen -- siehe Tabelle unten                   \\
\end{longtable}

\noindent Die 9 Flag-Kombinationen im Detail:
...
\begin{longtable}[]{@{}
	...
	\texttt{zgc-coh-on}           & \texttt{-XX:+UseZGC}\newline\texttt{-XX:+UnlockExperimentalVMOptions}\newline\texttt{-XX:+UseCompactObjectHeaders}  & ZGC + Compact Object Headers: Low-Latency-GC mit kleinerem Live-Set            \\
	\rowcolor{rowalt}
...
\subsubsection{Ebene 2: 13 Laufzeitprofile}
\label{sec:ebene2}
...
\begin{longtable}[]{@{}
	...
	\rowcolor{rowalt}
	P13 Virtual Threads    & \texttt{eclipse-temurin:25-jre}                    & Project Loom: Tomcat nutzt Virtual Threads statt Platform-Threads       \\
\end{longtable}
